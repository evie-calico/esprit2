...
local function impl_modules_for_types(auxilary_modules, types)
	local resources = {}
	for _, type in ipairs(types) do
		resources[type] = function(key)
			return function(table)
				for field, module in pairs(auxilary_modules) do
...
local resources = impl_modules_for_types(
	{ textures = init_textures },
	{ "attack", "component", "sheet", "spell", "vault" }
)

if init_textures then
	...
	-- TODO: nil, not ""
	function resources.texture() return "" end
end
